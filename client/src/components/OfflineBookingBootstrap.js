...
class Booking extends Component {
    ...
    render() {
        ...
        return (
            <div className="border-solid-1px-black margin-5-5 offline-booking">

                <br />
                <div className="row text-center font-20-bold">Offline Booking</div>
                    <FormControl
                        type = 'text'
                ...
                <div align='center'>
                    <button type="button" class="btn btn-primary" onClick={this.Submit}>Book</button>
                </div>
